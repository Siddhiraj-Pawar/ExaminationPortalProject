...
import com.app.servicesImplementation.UserDetailsServiceImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        web.httpFirewall(allowUrlPatterns()); // Apply the custom firewall here
    }
